        ...
        <div className="mx-auto flex h-16 w-[min(1024px,calc(100%-32px))] items-center justify-between gap-4">
          ...
          <div className="hidden items-center gap-3 md:flex">
            <button
              onClick={logout}
              disabled={busy}
              className="inline-flex items-center gap-2 rounded-lg px-2 py-2 text-sm font-bold text-sky-700 transition hover:bg-sky-50 disabled:cursor-not-allowed disabled:opacity-60"
            >
          ...
          <button
            className="grid size-9 place-items-center rounded-lg bg-slate-100 text-slate-700 md:hidden"
        ...
        {open && (
          <div className="mx-auto grid w-[min(1024px,calc(100%-32px))] gap-2 pb-4 md:hidden">
            ...
            <button
              onClick={logout}
              disabled={busy}
              className="inline-flex items-center gap-2 rounded-lg bg-rose-50 px-3 py-2 text-sm font-bold text-rose-700 disabled:cursor-not-allowed disabled:opacity-60"
            >
              <LogOut className="size-4" />
              Log out
            </button>
