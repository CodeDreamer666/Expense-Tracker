...
export default async function Dashboard({
    ...
    const fixed = data.budget?.fixedCosts.reduce((sum: any, item: any) => sum + item.amountCents, 0) ?? 0;
    const spent = data.expenses.reduce((sum: any, item: any) => sum + item.amountCents, 0);
